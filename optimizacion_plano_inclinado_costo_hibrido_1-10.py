# -*- coding: utf-8 -*-
"""
Created on Thu Oct  1 18:55:11 2020
...
def costo(pars, rayo_pix_costo   ):
  ...
  Distancia2D_costo= DistanciasX_costo+DistanciasY_costo
  ...
  # alfa_pix=Distancia2D_costo/DistanciaPix
  


  return Distancia2D_costo + DistanciaPix*alfa_pix
